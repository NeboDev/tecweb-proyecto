...
function loadDashboardStats() {
    $.get(`${baseURL}/stats/counts`, function (data) {
...
function loadTopResources() {
    $.get(`${baseURL}/stats/top-resources`, function (data) {
...
function loadCharts() {
    ...
    $.get(`${baseURL}/stats/by-date`, function (data) {
    ...
    $.get(`${baseURL}/stats/type-abs`, function (data) {
